  ...
  return <div className="min-h-screen">
    <header className="bg-ink text-white">
      <div className="mx-auto flex max-w-[1280px] items-center justify-between px-5 py-6 lg:px-8">
        ...
        <div className="text-right"><p className="text-[10px] uppercase tracking-[.14em] text-white/45">Atualização</p><p className="mt-1 text-xs text-white/80">Diariamente</p></div>
      </div>
